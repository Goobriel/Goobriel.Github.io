...
app.post("/api/contactform/create", (req, res) => {
  ...
  const sql =
    "INSERT INTO contactform (name, phonenum, email, subject, message) VALUES ($1,$2,$3,$4,$5)";
...
app.post("/api/reviews/create", (req, res) => {
  ...
  const sql =
    "INSERT INTO reviews (reviewname, locate, response) VALUES ($1,$2,$3)";
...
app.post("/api/purchased/create", (req, res) => {
  ...
  const sql =
    "INSERT INTO purchased (product, price, orderID) VALUES ($1,$2,$3)";
